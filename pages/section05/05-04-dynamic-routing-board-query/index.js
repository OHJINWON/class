...
export default function StaticRoutingPage() {
    ...
    return (
        <div>
            <button onClick={onClickMove1}>1번 dynamic 게시글로 이동하기!!!</button>
            <button onClick={onClickMove2}>2번 dynamic 게시글로 이동하기!!!</button>
            <button onClick={onClickMove3}>3번 dynamic 게시글로 이동하기!!!</button>
        </div>
    )   
